...
plotting_verticies = [];
plotting_updated_verticies = [];

% loop through all polytopes
for i = 1:length(polytopes)
    new_verts = [];
    if flag_do_plot
        plotting_verticies = [plotting_verticies; polytopes(i).vertices; nan nan]; %#ok<AGROW>
    end
    ...
    if flag_do_plot
        plotting_updated_verticies = [plotting_updated_verticies; polytopes(i).vertices; nan nan]; %#ok<AGROW>       
    end
end
...
if flag_do_plot
    ...
    plot(plotting_verticies(:,1),plotting_verticies(:,2),'k.-','DisplayName','original verticies','MarkerSize',10);
    %plot(plotting_verticies(:,1),plotting_verticies(:,2),'kx','DisplayName','original verticies');
    
    % Plot updated verticies
    plot(plotting_updated_verticies(:,1),plotting_updated_verticies(:,2),'r.','DisplayName','dense verticies','MarkerSize',5);
