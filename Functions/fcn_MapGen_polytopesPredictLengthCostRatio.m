function [field_small_choice_angles,field_big_choice_angles,r_lc_estimates] =...
    fcn_MapGen_polytopesPredictLengthCostRatio(pre_shrink_polytopes,polytopes,gap_size,travel_direction,L_E, varargin)
...
% EXAMPLES:
%
% See the script: script_test_fcn_MapGen_polytopesPredictLengthCostRatio.m
