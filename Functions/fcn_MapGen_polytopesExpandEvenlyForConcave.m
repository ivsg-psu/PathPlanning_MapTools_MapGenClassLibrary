...
expandedPolytopes= fcn_MapGen_polytopesFillFieldsFromVertices(expandedPolytopes,1, -1); % fill polytopes from vertices
...
if flag_do_plots
    ...
    fillFormat = [];
    h_plot = fcn_MapGen_plotPolytopes(expandedPolytopes, (plotFormat), (fillFormat), (figNum)); %#ok<NASGU>
