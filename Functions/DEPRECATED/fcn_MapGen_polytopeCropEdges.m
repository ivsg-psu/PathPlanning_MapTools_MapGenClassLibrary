...
warning('fcn_MapGen_polytopesCropEdges is being deprecated. Use fcn_MapGen_polytopesDeleteByAABB instead.');

% fcn_MapGen_polytopesCropEdges removes polytopes that extend
% beyond the boundaries specified
%
% FORMAT:
%
% trimmedPolytopes = fcn_MapGen_polytopesCropEdges( polytopes, boundingBox, (fig_num))
%
% INPUTS:
%
...
% EXAMPLES:
%
% For examples, see: script_test_fcn_MapGen_polytopesCropEdges
%
...
%    % renamed 
%    % to fcn_MapGen_polytopesCropEdges, for consistency
