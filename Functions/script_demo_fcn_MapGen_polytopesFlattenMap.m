% script_demo_fcn_MapGen_polytopesFlattenMap
% Tests: fcn_MapGen_polytopesFlattenMap
...
flattened_polytopes = fcn_MapGen_polytopesFlattenMap(polytopes);
...
% flattened_polytopes = fcn_MapGen_polytopesFlattenMap(polytopes);
flattened_polytopes = fcn_MapGen_polytopesFlattenMap(polytopes(1:2));
