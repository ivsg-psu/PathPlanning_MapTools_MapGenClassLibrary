...
assert(isnumeric(verticesIncludingSelfIntersections));
assert(isnumeric(flag_wasIntersection));

% Check variable sizes
Nvertices = length(vertices(:,1));
assert(size(verticesIncludingSelfIntersections,1)>=Nvertices); 
assert(size(verticesIncludingSelfIntersections,2)==2); 
assert(size(flag_wasIntersection,1)==1); 
assert(size(flag_wasIntersection,2)==1); 

% Check variable values
assert(isequal(round(verticesIncludingSelfIntersections,4),round(...
    [...
    0         0
    1.0000         0
    0.6667    1.0000
...
% Check variable values
assert(isequal(verticesIncludingSelfIntersections,vertices));
...
[verticesIncludingSelfIntersections, flag_wasIntersection] = ...
    fcn_MapGen_polytopeFindSelfIntersections(vertices, (-1));
