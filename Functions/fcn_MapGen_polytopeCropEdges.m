function [trim_polytopes] = ...
    fcn_MapGen_polytopeCropEdges(polytopes,bounding_box)
% fcn_MapGen_polytopeCropEdges removes polytopes that extend 
% beyond the boundaries specified
%
% [TRIM_POLYTOPES]=fcn_MapGen_polytopeCropEdges(POLYTOPES,XLOW,XHIGH,YLOW,YHIGH)
% returns:
...
%   trim_polytopes = fcn_MapGen_polytopeCropEdges(polytopes,0,1,0,1);
...
% TO DO
% -- Put it in same format as others, including an example script
