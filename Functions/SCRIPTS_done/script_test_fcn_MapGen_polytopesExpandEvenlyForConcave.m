...
[polytopes,~] =fcn_MapGen_nameToMap(...
    map_name,...
    plot_flag,...
    disp_name,...
    -1,...
...
% Call the function
expandedPolytopes = fcn_MapGen_polytopesExpandEvenlyForConcave(polytopes, expansionDistance, []);
...
% Call the function
expandedPolytopes = fcn_MapGen_polytopesExpandEvenlyForConcave(polytopes, expansionDistance, -1);
