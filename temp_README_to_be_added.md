...
<!-- TODO when automatic dependency management is added to this repo, some commented out lines need to be uncommented.  These are flagged with TODOs-->
<!--
...
<p align="center">
  ...
  <h2 align="center"> PathPlanning_MapTools_MapGenClassLibrary
  </h2>

![image](https://user-images.githubusercontent.com/82562987/220433283-6671f515-90d0-4ff6-9c67-6def22fd7453.png)

  <p align="center">
    The purpose of this code is to generate, modify, and analyze maps of obstacle fields.  The obstacles are stored as polytopes in vertex representation.  Fore information on this procedure and its utilities please see <a href="https://etda.libraries.psu.edu/catalog/18657sat5340">Seth Tau's thesis</a> or <a href="http://gvsets.ndia-mich.org/documents/AAIR/2022/Path-Free%20Estimation%20of%20Navigation%20Distance%20using%20Obstacle%20Shape%20Statistics%20and%20Density.pdf"> this paper </a>.
    <br />
...
2. Clone the repo
   ...
   ```
3. Run the main code in the root of the folder (`script_demo_MapGenLibrary.m`).
<!--TODO uncomment this when dependency management is added to this repo: this will download the required utilities for this code, unzip the zip files into a Utilities folder (.\Utilities), and update the MATLAB path to include the Utility locations. This install process will only occur the first time. Note: to force the install to occur again, delete the Utilities directory and clear all global variables in MATLAB (type: "clear global *").-->
4. Confirm it works! 
<!--TODO uncomment this when dependency management is added to this repo: Run `script_demo_MapGenLibrary`. If the code works, the script should run without errors.--> 
This script produces numerous example images such as those in this README file.
...
<!--TODO uncomment this when dependency management is added to this repo: 2. After running the main script to define the included directories for utility functions, -->
2. one can then navigate to the Functions directory and run any of the functions or scripts there as well. All functions for this library are found in the Functions sub-folder, and each has an associated test script. Run any of the various test scripts, such as:
...
Project Link: [hhttps://github.com/ivsg-psu/PathPlanning_MapTools_MapGenClassLibrary](https://github.com/ivsg-psu/PathPlanning_MapTools_MapGenClassLibrary)
